...
{text="Bekle l&uuml;tfen! HabboTR.net y&uuml;kleniyor.  ";document.getElementById('wrapperLoader').style.backgroundImage="url(http://habbotr.net/public/images/index/bg.png)";}
else if(jjLoader.progressNow>29&&jjLoader.progressNow<67)
{text="Bekle l&uuml;tfen! HabboTR.net y&uuml;kleniyor.  ";document.getElementById('wrapperLoader').style.backgroundImage="url(http://habbotr.net/public/images/index/bg.png)";}
else if(jjLoader.progressNow>66&&jjLoader.progressNow<83)
{text="Az kaldi! HabboTR.net y&uuml;kleniyor.  ";}
else if(jjLoader.progressNow>82&&jjLoader.progressNow<90)
{text="Juhuu! Bitti!   ";document.getElementById('wrapperLoader').style.backgroundImage="url(http://habbotr.net/public/images/index/bg.png)";}

...
<div id="main" class="container_12 animated fadeInLeft">
			...
			<div class="title9" style="width: 90%;border-bottom: 2px solid rgba(0,0,0,0.2);margin-top: 10px;">{name} Staffs</div>																																																
...
<div class="boxd" style="margin-top: 20px;width: 100%;height: 482px;">
				   <div class="title9" style="width: 90%;border-bottom: 2px solid rgba(0,0,0,0.2);margin-top: 10px;">{name} Moderation</div>																																																
				<!- BEGIN userstaff ->

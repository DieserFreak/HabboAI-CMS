...
$token = md5(md5(md5(md5(rand(0, 9999999999999999999999)))));
...
$.post("<?php echo $path; ?>/public/loader/client/Flappybird/score.php", {user_id: '<?php echo $user->id; ?>', score: highscore, game: 'flappybird', token: '<?php echo $token; ?>'})
.done(function (data) {
